    ...
    content: [
      [
        {
          superscript: 1,
          text:
            "The Lord our God is but one only living and true God; whose subsistence is in and of Himself,",
      ...
      [
        ...
        },
        {
          superscript: 20,
          text:
            "blessedness, in and of Himself, is alone in and unto Himself all-sufficient, not standing in need of any creature which He hath made, nor deriving any glory from them,",
        ...
        },
        {
          superscript: 22,
          text:
            "and He hath most sovereign dominion over all creatures, to do by them, for them, or upon them, whatsoever Himself pleases;",
        ...
        },
        {
          superscript: "",
          text:
            "service, or obedience, as creatures they owe unto the Creator, and whatever He is further pleased to require of them.",
          scriptures: []
        }
      ],
      [
    ...
    content: [
      [
        ...
        },
        {
          superscript: 3,
          text:
            "wisdom, and goodness, to create or make the world, and all things therein, whether visible or invisible, in the space of six days, and all very good.",
    ...
    content: [
      ...
      [
        ...
        },
        {
          superscript: 12,
          text:
            "and that not by a bare permission, which also He most wisely and powerfully binds, and otherwise orders and governs,",
      ...
      [
        ...
        },
        {
          superscript: 18,
          text:
            "from them He not only withholds His grace, whereby they might have been enlightened in their understanding, and wrought upon their hearts;",
    ...
    content: [
      ...
      [
        ...
        },
        {
          superscript: 9,
          text:
            "yet there is no sin so great that it shall bring damnation to them that repent,",
...
export default londonBaptistData;
